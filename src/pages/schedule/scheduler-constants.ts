export const activityArraySunday = [
  'First plenary',
  'Coffee break',
  'Second plenary (and last)',
  'Closing ceremony',
  '',
  '',
  '',
...
export const bubbleOptionsArraySunday = [
  {
    connectTop: false,
    connectBotomn: true,
    colorHashT: '#D3D3D3',
...
export const activityArraySaturday = [
  'Third regional session',
  'Coffee break',
  'Fourth regional session',
  'Lunch break',
  'Second speaker session',
  'Q&A',
  'Fifth regional session',
  'Coffee break',
  'Sixth regional session',
  'Free Time',
  'Party Party Fun Fun '
]
...
export const hoursArraySaturday = [
  '9:00',
  '10:30',
  '11:00',
  '13:30',
